		...
		<main className='h-min-[100%] h-screen flex flex-col overflow-hidden'>
			...
			<div className='flex-1 flex flex-col items-center justify-center p-8 mt-16 md:mt-20'>
				<div className='drop-shadow-lg shadow-black dark:shadow-white'>
					<h2 className='uppercase text-3xl md:text-4xl text-secondary dark:text-gray-100 font-bold tracking-wide text-center drop-shadow-[0_0_0.3rem_#00000070] dark:drop-shadow-[0_0_0.3rem_#ffffff70] animate-left-right'>
						{translate('title')}{' '}
