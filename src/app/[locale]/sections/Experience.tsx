...
export const Experience: FC = () => {
  ...
  return (
    <section 
      id="experience" 
      ref={sectionRef}
      className="max-w-6xl mx-auto px-4 xl:px-0 py-24"
    >
      <motion.div
      ...
      <div className="flex flex-col gap-6 relative py-8">
        <div className="w-1 h-full absolute top-0 left-0 md:left-1/2 mx-auto bg-gray-200 dark:bg-gray-700 rounded-sm">
          <motion.div
